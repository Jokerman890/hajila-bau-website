...
Seit Version 0.6.0 wird keine Supabase-Integration mehr ausgeliefert. Die folgenden Informationen dienen ausschließlich zur Nachverfolgung älterer Releases (≤0.5.x).
