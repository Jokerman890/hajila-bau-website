...
import { ChevronDown, Sparkles, Zap, Cpu, Palette, Code, Globe, Layers, Building2, Hammer, LeafyGreen, Phone, Mail, MapPin, Clock, Scale, CalendarDays, Landmark, User, Accessibility, FileText, Lock, Moon, Sun, ChevronRight, Facebook, Instagram, Linkedin } from 'lucide-react';
...
const PremiumWebsite: React.FC = () => {
  ...
  const menuItems: NavItem[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          text: "3D Planung",
          description: "Präzise und detailreiche Planungen",
          to: "/3d-planung"
        },
      ]
    },
      ...
      items: [
        {
          ...
          text: "Standorte",
          description: "Unsere Niederlassungen",
          to: "/standorte"
        },
        {
          icon: <FileText className="h-4 w-4" />,
          text: "Zertifikate",
          description: "Unsere Qualifikationen",
          to: "/zertifikate"
        },
        {
          icon: <Clock className="h-4 w-4" />,
          text: "Karriere",
          description: "Jobs und Karrierechancen",
          to: "/karriere"
        },
        {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Background Effects */}
      <ParticleWave className="fixed inset-0 -z-10" />
      <BlueprintGrid className="fixed inset-0 -z-20" />

      {/* Content */}
      <div className="relative z-10">
        {/* Header */}
        <header className="sticky top-0 z-50 flex h-16 items-center justify-between border-b border-border bg-background/95 px-4 shadow-md backdrop-blur-sm">
          <div className="flex items-center gap-2">
            <span className="block h-8 w-8 rounded-full bg-gradient-to-br from-[#00C3E3] to-[#005B9F]"></span>
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={toggleTheme}
              className="flex h-10 w-10 items-center justify-center rounded-full bg-muted transition-all duration-200 ease-in-out hover:bg-muted/80"
            ...
            <button className="hidden rounded-full bg-gradient-to-br from-[#00C3E3] to-[#005B9F] px-4 py-2 text-sm font-semibold text-white shadow-md transition-all duration-200 ease-in-out hover:scale-105 lg:block">
              Angebot anfordern
            </button>

            <button className="rounded-full bg-muted px-4 py-2 text-sm font-semibold text-foreground transition-all duration-200 ease-in-out hover:bg-muted/80 lg:hidden">
              Menü
            </button>
          </div>
        </header>
        ...
        {/* Hero Section */}
        <div className="relative isolate overflow-hidden bg-cover bg-center py-32" style={{ backgroundImage: 'url(/hero-bg.jpg)' }}>
          ...
          <div className="container mx-auto px-4 text-center">
            <motion.h1
              ...
              className="mb-4 text-4xl font-extrabold leading-tight text-white sm:text-5xl"
            >
              Ihr Partner für Hochbau & Klinkerarbeiten
            </motion.h1>
            <motion.p
            ...
            >
              Wir bieten Ihnen hochwertige Lösungen für Ihr Bauprojekt. Von der Planung bis zur Umsetzung.
            </motion.p>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
              <motion.button
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.7 }}
                className="rounded-full bg-gradient-to-br from-[#00C3E3] to-[#005B9F] px-8 py-3 text-base font-semibold text-white shadow-md transition-all duration-200 ease-in-out hover:scale-105"
              >
                Jetzt anfragen
              </motion.button>
              ...
              <motion.button
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.7 }}
                className="rounded-full bg-muted px-8 py-3 text-base font-semibold text-foreground transition-all duration-200 ease-in-out hover:bg-muted/80"
              >
                Mehr erfahren
              </motion.button>
            </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            {/* Services Overview */}
            <div className="rounded-2xl bg-white/95 p-8 shadow-md transition-all duration-200 ease-in-out hover:shadow-lg">
              <h2 className="mb-6 text-2xl font-bold text-foreground">
                Unsere Leistungen
              </h2>
              <div className="flex flex-col gap-4">
                {menuItems[0].items?.map(({ icon, text, description, to }, index) => (
                  <div
                    key={index}
                    className="flex cursor-pointer items-center gap-4 rounded-lg p-4 transition-all duration-200 ease-in-out hover:bg-muted/50"
                  >
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#00C3E3] to-[#005B9F] text-white">
                      {icon}
                    </div>
            ...
            <div className="rounded-2xl bg-white/95 p-8 shadow-md transition-all duration-200 ease-in-out hover:shadow-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Wir sind ein erfahrenes Bauunternehmen mit Sitz in Osnabrück. Unser Team aus qualifizierten Fachleuten setzt Ihr Bauprojekt mit höchster Präzision und Sorgfalt um.
              </p>
              <div className="mt-4 flex flex-col gap-2">
                <button className="rounded-full bg-gradient-to-br from-[#00C3E3] to-[#005B9F] px-6 py-2 text-sm font-semibold text-white shadow-md transition-all duration-200 ease-in-out hover:scale-105">
                  Mehr erfahren
                </button>
                <button className="rounded-full bg-muted px-6 py-2 text-sm font-semibold text-foreground transition-all duration-200 ease-in-out hover:bg-muted/80">
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {/* Blog Post Card */}
              <div className="rounded-2xl bg-white/95 p-6 shadow-md transition-all duration-200 ease-in-out hover:shadow-lg">
                <div className="mb-4 h-40 rounded-lg bg-gradient-to-br from-[#00C3E3] to-[#005B9F]">
                  {/* Image or Video Thumbnail */}
                </div>
                <h3 className="mb-2 text-lg font-semibold text-foreground">
                  Tipps für die Auswahl des richtigen Bauunternehmens
                </h3>
                <p className="text-sm text-muted-foreground">
                  Erfahren Sie, worauf Sie bei der Auswahl eines Bauunternehmens achten sollten, um Ihr Traumprojekt zu verwirklichen.
                </p>
                <div className="mt-4 flex items-center gap-2">
                  <span className="block rounded-full bg-muted px-3 py-1 text-xs font-semibold text-foreground">
                    Bauwesen
                  </span>
                  <span className="block rounded-full bg-muted px-3 py-1 text-xs font-semibold text-foreground">
                    Tipps
              ...
              <div className="rounded-2xl bg-white/95 p-6 shadow-md transition-all duration-200 ease-in-out hover:shadow-lg">
                ...
                <h3 className="mb-2 text-lg font-semibold text-foreground">
                  Die Vorteile von Klinkerfassaden
                </h3>
                <p className="text-sm text-muted-foreground">
                  Entdecken Sie die Vorteile von Klinkerfassaden für Ihr Bauprojekt und warum sie eine nachhaltige Wahl sind.
                </p>
                <div className="mt-4 flex items-center gap-2">
                  <span className="block rounded-full bg-muted px-3 py-1 text-xs font-semibold text-foreground">
                    Klinkerarbeiten
              ...
              <div className="rounded-2xl bg-white/95 p-6 shadow-md transition-all duration-200 ease-in-out hover:shadow-lg">
                ...
                <h3 className="mb-2 text-lg font-semibold text-foreground">
                  3D Planung: Der Schlüssel zu Ihrem Traumhaus
                </h3>
                <p className="text-sm text-muted-foreground">
                  Erfahren Sie, wie unsere 3D Planungsdienstleistungen Ihnen helfen können, Ihr Traumhaus zu visualisieren und zu realisieren.
                </p>
                <div className="mt-4 flex items-center gap-2">
                  <span className="block rounded-full bg-muted px-3 py-1 text-xs font-semibold text-foreground">
                    3D Planung
        ...
        {/* Footer */}
        <footer className="mt-32 border-t border-border bg-background/95 py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
              <div>
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>
                    <a href="/ueber-uns" className="hover:text-foreground">
                      Über uns
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/referenzen" className="hover:text-foreground">
                      Referenzen
                    </a>
                  </li>
                  <li>
                    <a href="/karriere" className="hover:text-foreground">
                      Karriere
                    </a>
                  </li>
                  <li>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a
                    href="https://www.facebook.com/hajilabau"
                    className="flex h-10 w-10 items-center justify-center rounded-full bg-muted transition-all duration-200 ease-in-out hover:bg-muted/80"
                    aria-label="Folgen Sie uns auf Facebook"
                  >
                    <Facebook className="h-5 w-5 fill-current text-foreground" />
                  </a>
                  <a
                    href="https://www.instagram.com/hajilabau"
                    className="flex h-10 w-10 items-center justify-center rounded-full bg-muted transition-all duration-200 ease-in-out hover:bg-muted/80"
                    aria-label="Folgen Sie uns auf Instagram"
                  >
                    <Instagram className="h-5 w-5 fill-current text-foreground" />
                  </a>
                  <a
                    href="https://www.linkedin.com/company/hajilabau"
                    className="flex h-10 w-10 items-center justify-center rounded-full bg-muted transition-all duration-200 ease-in-out hover:bg-muted/80"
                    aria-label="Folgen Sie uns auf LinkedIn"
                  >
                    <Linkedin className="h-5 w-5 fill-current text-foreground" />
                  </a>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="mb-4 text-sm text-muted-foreground">
                  Erhalten Sie die neuesten Nachrichten und Angebote direkt in Ihr Postfach.
                </p>
                <form className="flex flex-col gap-2">
                  <input
                    type="email"
                    placeholder="Ihre E-Mail-Adresse"
                    className="rounded-full border border-border bg-white px-4 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-[#00C3E3] focus:ring-offset-2"
                    required
                  />
                  <button className="rounded-full bg-gradient-to-br from-[#00C3E3] to-[#005B9F] px-6 py-2 text-sm font-semibold text-white shadow-md transition-all duration-200 ease-in-out hover:scale-105">
                    Abonnieren
            ...
            <div className="mt-16 border-t border-border pt-8 text-center text-sm text-muted-foreground">
              <p>
                &copy; 2023 Hajila Bau GmbH. Alle Rechte vorbehalten.
              </p>
              <p>
                Erstellt von{" "}
                <a
                  href="https://www.deinunternehmen.de"
